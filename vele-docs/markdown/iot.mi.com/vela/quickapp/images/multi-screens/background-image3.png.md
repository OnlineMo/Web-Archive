...
::: nav-item
[组件](../../zh/components/index.html){.nav-link}
:::

::: nav-item
[JS接口](../../zh/features/index.html){.nav-link}
:::

::: nav-item
[编程示例](../../zh/samples/index.html){.nav-link}
:::

::: nav-item
[工具](../../zh/tools/index.html){.nav-link}
:::
...
-   ::: {.section .sidebar-group .depth-0}
    ...
    .clickable .open}
    -   [安装环境](../../zh/guide/start/use-ide.html){.sidebar-link}
    -   [项目结构](../../zh/guide/start/project-overview.html){.sidebar-link}
    -   [编写页面UI](../../zh/guide/start/user-interface.html){.sidebar-link}
    -   [添加交互](../../zh/guide/start/add-interactivity.html){.sidebar-link}
    -   [数据获取](../../zh/guide/start/data-fetch.html){.sidebar-link}
    -   [编译参数](../../zh/guide/start/toolkit-params.html){.sidebar-link}
    :::

-   ::: {.section .sidebar-group .depth-0}
    [基础功能](../../zh/guide/framework/index.html){.sidebar-heading
    .clickable}
    -   [项目结构](../../zh/guide/framework/project-structure.html){.sidebar-link}

    -   [项目配置](../../zh/guide/framework/manifest.html){.sidebar-link}

    -   [UX 文件](../../zh/guide/framework/ux.html){.sidebar-link}

    -   ::: {.section .sidebar-group .collapsable .is-sub-group .depth-1}
        [模板语法 []{.arrow
        .right}](../../zh/guide/framework/template/index.html){.sidebar-heading
        .clickable}
        :::

    -   ::: {.section .sidebar-group .collapsable .is-sub-group .depth-1}
        [样式语法 []{.arrow
        .right}](../../zh/guide/framework/style/index.html){.sidebar-heading
        .clickable}
        :::

    -   ::: {.section .sidebar-group .collapsable .is-sub-group .depth-1}
        [脚本语法 []{.arrow
        .right}](../../zh/guide/framework/script/index.html){.sidebar-heading
        .clickable}
        :::

    -   [页面切换](../../zh/guide/framework/page-switch.html){.sidebar-link}
    :::

-   ::: {.section .sidebar-group .depth-0}
    [进阶功能](../../zh/guide/framework/other/index.html){.sidebar-heading
    .clickable}
    -   [多语言覆盖](../../zh/guide/framework/other/i18n.html){.sidebar-link}

    -   [后台运行](../../zh/guide/framework/other/background-running.html){.sidebar-link}

    -   [hap
        链接](../../zh/guide/framework/other/hap-schema.html){.sidebar-link}

    -   [页面启动模式](../../zh/guide/framework/other/launch-mode.html){.sidebar-link}

    -   ::: {.section .sidebar-group .is-sub-group .depth-1}
        [多屏适配](../../zh/guide/multi-screens/index.html){.sidebar-heading
        .clickable}
        -   [适配规范](../../zh/guide/multi-screens/specs.html){.sidebar-link}
        -   [代码示例](../../zh/guide/multi-screens/samples.html){.sidebar-link}
        -   [条件编译](../../zh/guide/multi-screens/conditional-compilation.html){.sidebar-link}
        :::
    :::

-   ::: {.section .sidebar-group .depth-0}
    [开发者物料](../../zh/guide/developer-materials/index.html){.sidebar-heading
    .clickable}
    -   [拓展组件](../../zh/guide/developer-materials/extension-components.html){.sidebar-link}
    :::

-   ::: {.section .sidebar-group .depth-0}
    [设计指南](../../zh/guide/design/index.html){.sidebar-heading
    .clickable}
    -   [多屏设计](../../zh/guide/design/multi-screens.html){.sidebar-link}
    :::

-   ::: {.section .sidebar-group .depth-0}
    [最佳实践](../../zh/guide/best-practice/index.html){.sidebar-heading
    .clickable}
    -   [内存优化](../../zh/guide/best-practice/memory.html){.sidebar-link}
    -   [常用业务优化](../../zh/guide/best-practice/business.html){.sidebar-link}
    -   [启动时延优化](../../zh/guide/best-practice/start.html){.sidebar-link}
    :::

-   ::: {.section .sidebar-group .depth-0}
    [发布](../../zh/guide/publish/index.html){.sidebar-heading
    .clickable}
    -   [验收标准](../../zh/guide/publish/acceptance-criteria.html){.sidebar-link}
    :::

-   ::: {.section .sidebar-group .depth-0}
    [版本说明](../../zh/guide/version/index.html){.sidebar-heading
    .clickable}
...
-   ::: {.section .sidebar-group .depth-0}
    ...
    -   [常见问题](../../zh/guide/other/faq.html){.sidebar-link}
    -   [注意事项](../../zh/guide/other/tips.html){.sidebar-link}
    :::
...
-   **[适配规范](../../zh/guide/multi-screens/specs.html)：**
    框架支持不同形状、尺寸和分辨率的屏幕自适应，确保应用在各种设备上都能提供良好的视觉体验。
-   **[设计规范](../../zh/guide/design/multi-screens.html)：**
    Vela提供了一套多屏设计的技术规范，帮助开发者按照设计稿完成应用的多屏适配。
-   **[多屏UI模拟器](../../zh/guide/multi-screens/simulator.html)：**
...
模板](../../zh/guide/framework/template/index.html)、[style
样式](../../zh/guide/framework/style/index.html)和[script
脚本](../../zh/guide/framework/script/index.html)3
