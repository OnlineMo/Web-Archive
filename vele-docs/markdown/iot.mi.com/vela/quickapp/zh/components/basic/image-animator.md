...
-   [简体中文](image-animator.html){.nav-link .router-link-exact-active
    .router-link-active aria-current="page"}
-   [English](https://iot.mi.com/vela/quickapp/en/components/basic/image-animator.html){.nav-link}
:::
:::
:::
:::
...
-   ::: {.section .sidebar-group .depth-0}
    ...
    -   [image-animator](image-animator.html){.active .sidebar-link
        aria-current="page"}
...
# [\#](image-animator.html#image-animator){.header-anchor} image-animator[[2+]{.badge .apilevel style="vertical-align:top;" v-15b7b770=""}](../../guide/version/APILevel2.html){.apilevel-a} {#image-animator}

## [\#](image-animator.html#概述){.header-anchor} 概述

图片帧动画播放器。

## [\#](image-animator.html#子组件){.header-anchor} 子组件

不支持

## [\#](image-animator.html#属性){.header-anchor} 属性
...
## [\#](image-animator.html#样式){.header-anchor} 样式

支持[通用样式](../general/style.html)

## [\#](image-animator.html#方法){.header-anchor} 方法
...
## [\#](image-animator.html#示例代码){.header-anchor} 示例代码
...
![](../../../images/components/image_animator.gif){style="width:300px;"}
:::

::: page-nav
[ ← [image](image.html){.prev} ]{.prev} [ [progress](progress.html) →
]{.next}
:::
:::
...
[概述](image-animator.html#概述 "概述")
:::

::: {.vuepress-toc-item .vuepress-toc-h2}
[子组件](image-animator.html#子组件 "子组件")
:::

::: {.vuepress-toc-item .vuepress-toc-h2}
[属性](image-animator.html#属性 "属性")
:::

::: {.vuepress-toc-item .vuepress-toc-h2}
[样式](image-animator.html#样式 "样式")
:::

::: {.vuepress-toc-item .vuepress-toc-h2}
[方法](image-animator.html#方法 "方法")
:::

::: {.vuepress-toc-item .vuepress-toc-h2}
[示例代码](image-animator.html#示例代码 "示例代码")
:::
:::
:::
