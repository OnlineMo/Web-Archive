...
-   [简体中文](prompt.html){.nav-link .router-link-exact-active
    .router-link-active aria-current="page"}
-   [English](https://iot.mi.com/vela/quickapp/en/features/other/prompt.html){.nav-link}
:::
:::
:::
:::
...
-   ::: {.section .sidebar-group .depth-0}
    ...
    .open}
    -   [音频 audio](audio.html){.sidebar-link}
    -   [弹窗 prompt](prompt.html){.active .sidebar-link
        aria-current="page"}
    :::

::: {.page role="main"}
::: {.theme-default-content .content__default}
# [\#](prompt.html#弹窗-prompt){.header-anchor} 弹窗 prompt

## [\#](prompt.html#接口声明){.header-anchor} 接口声明
...
## [\#](prompt.html#导入模块){.header-anchor} 导入模块
...
## [\#](prompt.html#接口定义){.header-anchor} 接口定义

### [\#](prompt.html#prompt-showtoast-object){.header-anchor} prompt.showToast(OBJECT) {#prompt-showtoast-object}

显示 Toast 提示信息

#### [\#](prompt.html#参数){.header-anchor} 参数
...
#### [\#](prompt.html#示例){.header-anchor} 示例：
...
[接口声明](prompt.html#接口声明 "接口声明")
:::

::: {.vuepress-toc-item .vuepress-toc-h2}
[导入模块](prompt.html#导入模块 "导入模块")
:::

::: {.vuepress-toc-item .vuepress-toc-h2}
[接口定义](prompt.html#接口定义 "接口定义")
:::

::: {.vuepress-toc-item .vuepress-toc-h3}
[prompt.showToast(OBJECT)](prompt.html#prompt-showtoast-object "prompt.showToast(OBJECT)")
:::
:::
:::
