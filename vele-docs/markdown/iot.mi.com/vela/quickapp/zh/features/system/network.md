...
-   [简体中文](network.html){.nav-link .router-link-exact-active
    .router-link-active aria-current="page"}
-   [English](https://iot.mi.com/vela/quickapp/en/features/system/network.html){.nav-link}
:::
:::
:::
:::
...
-   ::: {.section .sidebar-group .depth-0}
    ...
    -   [网络信息 network](network.html){.active .sidebar-link
        aria-current="page"}
...
# [\#](network.html#网络信息-network){.header-anchor} 网络信息 network

## [\#](network.html#接口声明){.header-anchor} 接口声明
...
## [\#](network.html#导入模块){.header-anchor} 导入模块
...
## [\#](network.html#接口定义){.header-anchor} 接口定义

### [\#](network.html#network-gettype-object){.header-anchor} network.getType(OBJECT) {#network-gettype-object}

获取网络类型

#### [\#](network.html#参数){.header-anchor} 参数：
...
#### [\#](network.html#示例){.header-anchor} 示例：
...
### [\#](network.html#network-subscribe-object){.header-anchor} network.subscribe(OBJECT) {#network-subscribe-object}

监听网络类型变化。如果多次调用，仅最后一次调用生效

#### [\#](network.html#参数-2){.header-anchor} 参数： {#参数-2}
...
#### [\#](network.html#示例-2){.header-anchor} 示例： {#示例-2}
...
### [\#](network.html#network-unsubscribe){.header-anchor} network.unsubscribe() {#network-unsubscribe}

取消监听网络类型变化

#### [\#](network.html#参数-3){.header-anchor} 参数： {#参数-3}

无

#### [\#](network.html#示例-3){.header-anchor} 示例： {#示例-3}
...
## [\#](network.html#支持明细){.header-anchor} 支持明细
...
::: page-nav
[ ← [文件存储 file](../data/file.html){.prev} ]{.prev} [ [振动
vibrator](vibrator.html) → ]{.next}
:::
:::
...
[接口声明](network.html#接口声明 "接口声明")
:::

::: {.vuepress-toc-item .vuepress-toc-h2}
[导入模块](network.html#导入模块 "导入模块")
:::

::: {.vuepress-toc-item .vuepress-toc-h2}
[接口定义](network.html#接口定义 "接口定义")
:::

::: {.vuepress-toc-item .vuepress-toc-h3}
[network.getType(OBJECT)](network.html#network-gettype-object "network.getType(OBJECT)")
:::

::: {.vuepress-toc-item .vuepress-toc-h3}
[network.subscribe(OBJECT)](network.html#network-subscribe-object "network.subscribe(OBJECT)")
:::

::: {.vuepress-toc-item .vuepress-toc-h3}
[network.unsubscribe()](network.html#network-unsubscribe "network.unsubscribe()")
:::

::: {.vuepress-toc-item .vuepress-toc-h2}
[支持明细](network.html#支持明细 "支持明细")
:::
:::
:::
