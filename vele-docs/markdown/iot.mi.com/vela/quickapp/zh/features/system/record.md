...
-   [简体中文](record.html){.nav-link .router-link-exact-active
    .router-link-active aria-current="page"}
-   [English](https://iot.mi.com/vela/quickapp/en/features/system/record.html){.nav-link}
:::
:::
:::
:::
...
#### [\#](record.html#pcm-wav-比特率参考){.header-anchor} PCM / WAV 比特率参考
...
#### [\#](record.html#opus-比特率参考){.header-anchor} Opus 比特率参考
...
## [\#](record.html#事件){.header-anchor} 事件

### [\#](record.html#record-onframerecorded){.header-anchor} record.onframerecorded {#record-onframerecorded}

监听已录制完指定帧大小的文件事件。如果设置了 frameSize，则会回调此事件。

#### [\#](record.html#回调object参数){.header-anchor} 回调Object参数：
...
#### [\#](record.html#示例-3){.header-anchor} 示例： {#示例-3}
...
::: {.vuepress-toc-item .vuepress-toc-h2}
[事件](record.html#事件 "事件")
:::

::: {.vuepress-toc-item .vuepress-toc-h3}
[record.onframerecorded](record.html#record-onframerecorded "record.onframerecorded")
:::
