...
-   [简体中文](zip.html){.nav-link .router-link-exact-active
    .router-link-active aria-current="page"}
-   [English](https://iot.mi.com/vela/quickapp/en/features/system/zip.html){.nav-link}
:::
:::
:::
:::
...
# [\#](zip.html#解压缩-zip){.header-anchor} 解压缩 zip

## [\#](zip.html#接口声明){.header-anchor} 接口声明
...
## [\#](zip.html#导入模块){.header-anchor} 导入模块
...
## [\#](zip.html#接口定义){.header-anchor} 接口定义

### [\#](zip.html#zip-decompress-object){.header-anchor} zip.decompress(OBJECT) {#zip-decompress-object}

解压文件

#### [\#](zip.html#参数){.header-anchor} 参数：
...
#### [\#](zip.html#success-返回值){.header-anchor} success 返回值：

无

#### [\#](zip.html#fail-返回值){.header-anchor} fail 返回值：
...
[接口声明](zip.html#接口声明 "接口声明")
:::

::: {.vuepress-toc-item .vuepress-toc-h2}
[导入模块](zip.html#导入模块 "导入模块")
:::

::: {.vuepress-toc-item .vuepress-toc-h2}
[接口定义](zip.html#接口定义 "接口定义")
:::

::: {.vuepress-toc-item .vuepress-toc-h3}
[zip.decompress(OBJECT)](zip.html#zip-decompress-object "zip.decompress(OBJECT)")
:::
:::
:::
