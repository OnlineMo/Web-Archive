...
-   [简体中文](business.html){.nav-link .router-link-exact-active
    .router-link-active aria-current="page"}
-   [English](https://iot.mi.com/vela/quickapp/en/guide/best-practice/business.html){.nav-link}
:::
:::
:::
:::
...
![alt
text](../../../images/components/business-swiper.jpg){style="max-width:100%;height:auto;"}
`Swiper懒加载实例`
:::
...
-   若对图片视觉质量无高要求，建议优先采用 PNG8
    格式，可有效降低图片体积、提升动画 / 页面的渲染帧率。
:::
