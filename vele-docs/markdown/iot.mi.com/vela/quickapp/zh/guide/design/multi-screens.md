...
-   [English](https://iot.mi.com/vela/quickapp/en/guide/design/multi-screens.html){.nav-link}
:::
:::
:::
:::
...
-   ::: {.section .sidebar-group .depth-0}
    [设计指南](index.html){.sidebar-heading .clickable
    .router-link-active .open}
    -   [多屏设计](multi-screens.html){.active .sidebar-link
        aria-current="page"}
    :::
...
# [\#](multi-screens.html#多屏设计){.header-anchor} 多屏设计

## [\#](multi-screens.html#小米智能穿戴设备){.header-anchor} 小米智能穿戴设备
...
## [\#](multi-screens.html#设计建议){.header-anchor} 设计建议
...
## [\#](multi-screens.html#弧形屏幕适配安全区域){.header-anchor} 弧形屏幕适配安全区域
...
![](../../../images/multi-screens/multi-safe-area.png){style="height:300px;"}
:::

::: page-nav
[ ← [拓展组件](../developer-materials/extension-components.html){.prev}
]{.prev} [ [内存优化](../best-practice/memory.html) → ]{.next}
:::
:::
...
[小米智能穿戴设备](multi-screens.html#小米智能穿戴设备 "小米智能穿戴设备")
:::

::: {.vuepress-toc-item .vuepress-toc-h2}
[设计建议](multi-screens.html#设计建议 "设计建议")
:::

::: {.vuepress-toc-item .vuepress-toc-h2}
[弧形屏幕适配安全区域](multi-screens.html#弧形屏幕适配安全区域 "弧形屏幕适配安全区域")
:::
:::
:::
