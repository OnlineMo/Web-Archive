...
-   ::: {.section .sidebar-group .depth-0}
    [开发者物料](index.html){.sidebar-heading .clickable
    .router-link-active .open}
    -   [拓展组件](extension-components.html){.active .sidebar-link
        aria-current="page"}
    :::
...
# [\#](extension-components.html#拓展组件){.header-anchor} 拓展组件

## [\#](extension-components.html#input-method){.header-anchor} input-method

### [\#](extension-components.html#概述){.header-anchor} 概述

输入法组件，适配不同屏幕形状，支持两种主流键盘布局------全键盘模式和九键模式下的中英文输入

### [\#](extension-components.html#示例预览){.header-anchor} 示例预览

#### [\#](extension-components.html#全键盘模式){.header-anchor} 全键盘模式
...
-   [Github![](data:image/svg+xml;base64,){.icon
    .outbound} [(opens new
    window)]{.sr-only}](https://github.com/NEORUAA/Vela_input_method){target="_blank"
    rel="noopener noreferrer"}
:::

::: page-nav
[ ← [动态组件](../framework/other/dynamic-component.html){.prev}
]{.prev} [ [多屏设计](../design/multi-screens.html) → ]{.next}
:::
:::
...
[input-method](extension-components.html#input-method "input-method")
:::

::: {.vuepress-toc-item .vuepress-toc-h3}
[概述](extension-components.html#概述 "概述")
:::

::: {.vuepress-toc-item .vuepress-toc-h3}
[示例预览](extension-components.html#示例预览 "示例预览")
:::

::: {.vuepress-toc-item .vuepress-toc-h3}
[项目地址](extension-components.html#项目地址 "项目地址")
:::
:::
:::
