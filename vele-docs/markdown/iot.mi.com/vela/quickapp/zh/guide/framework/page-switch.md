...
-   [简体中文](page-switch.html){.nav-link .router-link-exact-active
    .router-link-active aria-current="page"}
-   [English](https://iot.mi.com/vela/quickapp/en/guide/framework/page-switch.html){.nav-link}
:::
:::
:::
:::
...
-   ::: {.section .sidebar-group .depth-0}
    ...
    -   [页面切换](page-switch.html){.active .sidebar-link
        aria-current="page"}
    :::
...
# [\#](page-switch.html#页面切换){.header-anchor} 页面切换

## [\#](page-switch.html#通过接口-router-切换页面和传递参数){.header-anchor} 通过接口 router 切换页面和传递参数

### [\#](page-switch.html#切换页面){.header-anchor} 切换页面
...
### [\#](page-switch.html#传递参数){.header-anchor} 传递参数
...
## [\#](page-switch.html#接收参数){.header-anchor} 接收参数

现在，开发者已经了解了通过接口`router`在页面之间传递参数的方法，如何接收参数呢？

其实很简单，接口`router`传递的参数的接收方法完全一致：在页面的 ViewModel
的`protected`属性中声明使用的属性。

::: {.custom-block .warning}
注意

-   `protected`内定义的属性，允许被应用内部页面请求传递的数据覆盖，不允许被应用外部请求传递的数据覆盖
-   若希望参数允许被应用外部请求传递的数据覆盖，请在页面的 ViewModel
    的`public`属性中声明使用的属性
:::
...
::: page-nav
[ ← [生命周期](script/lifecycle.html){.prev} ]{.prev} [
[多语言覆盖](other/i18n.html) → ]{.next}
:::
:::
...
[通过接口 router
切换页面和传递参数](page-switch.html#通过接口-router-切换页面和传递参数 "通过接口 router 切换页面和传递参数")
:::

::: {.vuepress-toc-item .vuepress-toc-h3}
[切换页面](page-switch.html#切换页面 "切换页面")
:::

::: {.vuepress-toc-item .vuepress-toc-h3}
[传递参数](page-switch.html#传递参数 "传递参数")
:::

::: {.vuepress-toc-item .vuepress-toc-h2}
[接收参数](page-switch.html#接收参数 "接收参数")
:::
:::
:::
