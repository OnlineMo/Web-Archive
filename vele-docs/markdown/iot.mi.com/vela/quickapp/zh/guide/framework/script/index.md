...
-   [English](https://iot.mi.com/vela/quickapp/en/guide/framework/script/){.nav-link}
:::
:::
:::
:::
...
# [\#](index.html#script-脚本){.header-anchor} script 脚本

ux
文件中用来定义页面的逻辑代码，包括数据对象、生命周期接口、自定义方法、通用方法等。

## [\#](index.html#语法){.header-anchor} 语法

支持 ES5 / ES6 语法

### [\#](index.html#模块声明){.header-anchor} 模块声明

可以通过 import
引入功能模块，在代码中调用模块方法（具体参看接口部分文档说明）：
...
### [\#](index.html#代码引用){.header-anchor} 代码引用
...
JS 应用环境不是 node 环境，不要引用 node 原生模块，如
`import fs from 'fs'`。
:::

## [\#](index.html#页面数据对象){.header-anchor} 页面数据对象
...
## [\#](index.html#生命周期接口){.header-anchor} 生命周期接口
...
## [\#](index.html#自定义方法){.header-anchor} 自定义方法

开发者可以在应用/页面 ux
文件中按需声明自定义方法，包括一些工具方法、事件回调方法等，例如：
...
[模块声明](index.html#模块声明 "模块声明")
:::

::: {.vuepress-toc-item .vuepress-toc-h3}
[代码引用](index.html#代码引用 "代码引用")
:::

::: {.vuepress-toc-item .vuepress-toc-h2}
[页面数据对象](index.html#页面数据对象 "页面数据对象")
:::

::: {.vuepress-toc-item .vuepress-toc-h2}
[生命周期接口](index.html#生命周期接口 "生命周期接口")
:::

::: {.vuepress-toc-item .vuepress-toc-h2}
[自定义方法](index.html#自定义方法 "自定义方法")
:::

::: {.vuepress-toc-item .vuepress-toc-h2}
[全局对象和方法](index.html#全局对象和方法 "全局对象和方法")
:::

::: {.vuepress-toc-item .vuepress-toc-h2}
[通用方法](index.html#通用方法 "通用方法")
:::
:::
:::
