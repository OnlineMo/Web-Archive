...
-   [简体中文](page-data.html){.nav-link .router-link-exact-active
    .router-link-active aria-current="page"}
-   [English](https://iot.mi.com/vela/quickapp/en/guide/framework/script/page-data.html){.nav-link}
:::
:::
:::
:::
...
-   ::: {.section .sidebar-group .depth-0}
    ...
    -   ::: {.section .sidebar-group .collapsable .is-sub-group .depth-1}
        ...
        -   [页面数据对象](page-data.html){.active .sidebar-link
            aria-current="page"}
...
# [\#](page-data.html#页面数据对象){.header-anchor} 页面数据对象
...
::: page-nav
[ ← [全局属性和方法](global-data-method.html){.prev} ]{.prev} [
[生命周期](lifecycle.html) → ]{.next}
:::
:::
:::
