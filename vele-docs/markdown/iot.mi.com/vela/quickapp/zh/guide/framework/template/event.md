...
-   [English](https://iot.mi.com/vela/quickapp/en/guide/framework/template/event.html){.nav-link}
:::
:::
:::
:::
...
-   ::: {.section .sidebar-group .depth-0}
    ...
    -   ::: {.section .sidebar-group .collapsable .is-sub-group .depth-1}
        ...
        -   [事件绑定](event.html){.active .sidebar-link
            aria-current="page"}
...
# [\#](event.html#事件绑定){.header-anchor} 事件绑定

## [\#](event.html#格式){.header-anchor} 格式
...
## [\#](event.html#传参){.header-anchor} 传参

### [\#](event.html#常量){.header-anchor} 常量
...
### [\#](event.html#变量){.header-anchor} 变量
...
::: page-nav
[ ← [Props](Props.html){.prev} ]{.prev} [ [循环指令](for.html) →
]{.next}
:::
:::
