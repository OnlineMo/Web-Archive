...
-   [简体中文](acceptance-criteria.html){.nav-link
    .router-link-exact-active .router-link-active aria-current="page"}
-   [English](https://iot.mi.com/vela/quickapp/en/guide/publish/acceptance-criteria.html){.nav-link}
:::
:::
:::
:::
...
-   ::: {.section .sidebar-group .depth-0}
    [发布](index.html){.sidebar-heading .clickable .router-link-active
    .open}
    -   [验收标准](acceptance-criteria.html){.active .sidebar-link
        aria-current="page"}
    :::
...
# [\#](acceptance-criteria.html#验收标准){.header-anchor} 验收标准
...
::: page-nav
[ ← [启动时延优化](../best-practice/start.html){.prev} ]{.prev} [
[APILevel2](https://iot.mi.com/vela/quickapp/zh/guide/version/APILevel2.html)
→ ]{.next}
:::
:::
:::
