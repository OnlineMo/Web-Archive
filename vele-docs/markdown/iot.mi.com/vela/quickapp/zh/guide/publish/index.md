...
-   [English](https://iot.mi.com/vela/quickapp/en/guide/publish/){.nav-link}
:::
:::
:::
:::
...
-   ::: {.section .sidebar-group .depth-0}
    [发布](index.html){.sidebar-heading .clickable
    .router-link-exact-active .router-link-active .open .active
    aria-current="page"}
    -   [验收标准](acceptance-criteria.html){.sidebar-link}
    :::
...
# [\#](index.html#发布){.header-anchor} 发布

目前需要联系工作人员<zhangyuanpu@xiaomi.com>进行合作发布。
:::
:::
:::
