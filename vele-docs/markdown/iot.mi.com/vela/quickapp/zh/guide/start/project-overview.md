...
-   [简体中文](project-overview.html){.nav-link
    .router-link-exact-active .router-link-active aria-current="page"}
-   [English](https://iot.mi.com/vela/quickapp/en/guide/start/project-overview.html){.nav-link}
:::
:::
:::
:::
...
::: page-nav
[ ← [安装环境](use-ide.html){.prev} ]{.prev} [
[编写页面UI](user-interface.html) → ]{.next}
:::
:::
...
[目录结构](project-overview.html#目录结构 "目录结构")
:::
