...
-   [简体中文](toolkit-params.html){.nav-link .router-link-exact-active
    .router-link-active aria-current="page"}
-   [English](https://iot.mi.com/vela/quickapp/en/guide/start/toolkit-params.html){.nav-link}
:::
:::
:::
:::
...
-   ::: {.section .sidebar-group .depth-0}
    ...
    -   [编译参数](toolkit-params.html){.active .sidebar-link
        aria-current="page"}
    :::
...
# [\#](toolkit-params.html#编译参数){.header-anchor} 编译参数

编译工具提供了多种编译能力，开发者可以根据项目需求进行设置。请**注意**，编译参数仅在
`build`、`server`、`release` 命令中可用

## [\#](toolkit-params.html#如何设置编译参数){.header-anchor} 如何设置编译参数
...
## [\#](toolkit-params.html#查看当前工具支持的全部编译参数){.header-anchor} 查看当前工具支持的全部编译参数
...
::: page-nav
[ ← [数据获取](data-fetch.html){.prev} ]{.prev} [
[项目结构](../framework/project-structure.html) → ]{.next}
:::
:::
...
[如何设置编译参数](toolkit-params.html#如何设置编译参数 "如何设置编译参数")
:::

::: {.vuepress-toc-item .vuepress-toc-h2}
[查看当前工具支持的全部编译参数](toolkit-params.html#查看当前工具支持的全部编译参数 "查看当前工具支持的全部编译参数")
:::

::: {.vuepress-toc-item .vuepress-toc-h2}
[常见编译参数](toolkit-params.html#常见编译参数 "常见编译参数")
:::
:::
:::
