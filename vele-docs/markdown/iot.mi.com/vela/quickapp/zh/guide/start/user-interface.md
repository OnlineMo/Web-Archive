...
# [\#](user-interface.html#编写页面ui){.header-anchor} 编写页面UI

在上一节[项目结构](project-overview.html)中，介绍了 Vela JS
应用项目中各文件、目录的作用，对项目结构有了一定的了解之后，接下来我们会实现一个简单的天气预报App。
...
这个使用指南中，为了方便展示 Vela JS
应用中页面结构，样式和交互的开发，采用了上述的开发流程。开发者在实际开发中，也可以根据自己的开发习惯，选择适合自己的工作流。

::: {.custom-block .tip}
提示

这部分有比较多的代码片段，如果您已经对HTML/CSS/JavaScript很熟悉，您可以选择跳过此部分内容。
但我们还是建议您阅读本章的内容，以了解 Vela JS
应用开发和传统前端开发的一些区别。
:::

## [\#](user-interface.html#功能需求){.header-anchor} 功能需求
...
接下来的代码中，我们使用到了`div`、`text`和`image`组件，关于组件详细的使用方法，可以参考[Vela官方文档 -
组件](https://iot.mi.com/zh/components)。

### [\#](user-interface.html#实时天气){.header-anchor} 实时天气

实时天气页面，从整体上可以划分为上中下三部分：
`header`、`body`和`footer`，代码如下。
...
### [\#](user-interface.html#未来3天天气){.header-anchor} 未来3天天气
...
## [\#](user-interface.html#页面样式){.header-anchor} 页面样式

Vela支持常用的CSS特性，也进行了少量的扩充以及修改，默认支持对不同尺寸屏幕的适配。详细的属性支持情况可以在[属性列表](../../components/general/style.html#属性列表)中查询。

Vela JS
应用采用`flex`布局，可以方便实现常用的布局样式，关于`flex`布局的技术细节，可以参考[MDN文档![](data:image/svg+xml;base64,){.icon
.outbound} [(opens new
window)]{.sr-only}](https://developer.mozilla.org/zh-CN/docs/Web/CSS/flex){target="_blank"
rel="noopener noreferrer"}。
...
### [\#](user-interface.html#公共样式){.header-anchor} 公共样式
...
### [\#](user-interface.html#page){.header-anchor} page
...
### [\#](user-interface.html#头部信息){.header-anchor} 头部信息
...
## [\#](user-interface.html#列表渲染){.header-anchor} 列表渲染
...
[功能需求](user-interface.html#功能需求 "功能需求")
:::

::: {.vuepress-toc-item .vuepress-toc-h2}
[准备工作](user-interface.html#准备工作 "准备工作")
:::

::: {.vuepress-toc-item .vuepress-toc-h2}
[页面结构](user-interface.html#页面结构 "页面结构")
:::

::: {.vuepress-toc-item .vuepress-toc-h3}
[实时天气](user-interface.html#实时天气 "实时天气")
:::

::: {.vuepress-toc-item .vuepress-toc-h3}
[未来3天天气](user-interface.html#未来3天天气 "未来3天天气")
:::

::: {.vuepress-toc-item .vuepress-toc-h2}
[页面样式](user-interface.html#页面样式 "页面样式")
:::

::: {.vuepress-toc-item .vuepress-toc-h3}
[公共样式](user-interface.html#公共样式 "公共样式")
:::

::: {.vuepress-toc-item .vuepress-toc-h3}
[page](user-interface.html#page "page")
:::

::: {.vuepress-toc-item .vuepress-toc-h3}
[头部信息](user-interface.html#头部信息 "头部信息")
:::

::: {.vuepress-toc-item .vuepress-toc-h3}
[实时天气](user-interface.html#实时天气-2 "实时天气")
:::

::: {.vuepress-toc-item .vuepress-toc-h3}
[未来3天天气](user-interface.html#未来3天天气-2 "未来3天天气")
:::

::: {.vuepress-toc-item .vuepress-toc-h3}
[底部信息](user-interface.html#底部信息 "底部信息")
:::

::: {.vuepress-toc-item .vuepress-toc-h2}
[页面效果](user-interface.html#页面效果 "页面效果")
:::

::: {.vuepress-toc-item .vuepress-toc-h2}
[页面数据](user-interface.html#页面数据 "页面数据")
:::

::: {.vuepress-toc-item .vuepress-toc-h2}
[列表渲染](user-interface.html#列表渲染 "列表渲染")
:::

::: {.vuepress-toc-item .vuepress-toc-h3}
[条件渲染](user-interface.html#条件渲染 "条件渲染")
:::
:::
:::
