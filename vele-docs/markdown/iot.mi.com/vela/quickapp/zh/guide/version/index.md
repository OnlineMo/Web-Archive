...
::: nav-item
[教程](APILevel4.html){.nav-link .router-link-active}
:::
...
-   [English](https://iot.mi.com/vela/quickapp/en/guide/version/){.nav-link}
:::
:::
:::
:::
...
# [\#](index.html#apilevel){.header-anchor} APILevel

APILevel 用来标识当前框架提供的接口标准集合，文档中所有接口是默认属于
APILevel 1，如果
