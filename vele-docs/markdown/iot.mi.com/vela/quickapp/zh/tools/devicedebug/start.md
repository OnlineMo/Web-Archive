...
-   ::: {.section .sidebar-group .depth-0}
    ...
    -   [功能介绍](start.html){.active .sidebar-link
        aria-current="page"}
    :::
...
# [\#](start.html#功能介绍){.header-anchor} 功能介绍

支持开发**Xiaomi Vela
JS**应用时进行真机调试，在`AIoT-IDE`可通过设备ID连接真机，将应用推送到真机进行调试

## [\#](start.html#设备升级){.header-anchor} 设备升级

目前真机调试只支持 `Xiaomi Watch S4`
设备，请先联系小米工作人员获取`小米Vela设备真机调试全流程指南`
文档,按照文档内容，获取对应ota包将设备升级到支持真机调试的指定版本。注：升级固件存在一定风险，目前真机调试仅对特定合作方开放。

## [\#](start.html#环境准备){.header-anchor} 环境准备

1.  请使用测试版小米运动健康，连接测试用机
2.  请保证电脑网络和手机网络在一个局域网下

## [\#](start.html#连接){.header-anchor} 连接
...
::: page-nav
[ ← [优化评分](../debug/audit.html){.prev} ]{.prev} [
[AIoT-toolkit](../toolkit/start.html) → ]{.next}
:::
:::
...
[设备升级](start.html#设备升级 "设备升级")
:::

::: {.vuepress-toc-item .vuepress-toc-h2}
[环境准备](start.html#环境准备 "环境准备")
:::
