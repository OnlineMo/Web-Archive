...
-   ::: {.section .sidebar-group .depth-0}
    ...
    .clickable .open}
    -   [新建项目](creat-project.html){.sidebar-link}
    -   [项目类型](template.html){.sidebar-link}
    -   [管理项目](project.html){.active .sidebar-link
        aria-current="page"}
    :::
...
# [\#](project.html#管理项目){.header-anchor} 管理项目

对通过`AIoT-IDE`新建项目创建的**Xiaomi Vela
JS**应用项目，`AIoT-IDE`提供了删除和打开历史项目的功能。

## [\#](project.html#打开历史项目){.header-anchor} 打开历史项目
...
::: page-nav
[ ← [项目类型](template.html){.prev} ]{.prev} [
[设备管理](../emulator/create-emulator.html) → ]{.next}
:::
:::
...
[打开历史项目](project.html#打开历史项目 "打开历史项目")
:::

::: {.vuepress-toc-item .vuepress-toc-h2}
[删除项目](project.html#删除项目 "删除项目")
:::

::: {.vuepress-toc-item .vuepress-toc-h2}
[导入项目](project.html#导入项目 "导入项目")
:::
:::
:::
