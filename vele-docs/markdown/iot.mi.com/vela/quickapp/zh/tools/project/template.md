...
-   [简体中文](template.html){.nav-link .router-link-exact-active
    .router-link-active aria-current="page"}
-   [English](https://iot.mi.com/vela/quickapp/en/tools/project/template.html){.nav-link}
:::
:::
:::
:::
...
-   ::: {.section .sidebar-group .depth-0}
    ...
    -   [项目类型](template.html){.active .sidebar-link
        aria-current="page"}
    -   [管理项目](project.html){.sidebar-link}
    :::
...
# [\#](template.html#项目类型){.header-anchor} 项目类型
...
::: page-nav
[ ← [新建项目](creat-project.html){.prev} ]{.prev} [
[管理项目](project.html) → ]{.next}
:::
:::
:::
