...
-   ::: {.section .sidebar-group .depth-0}
    ...
    -   [了解界面](project.html){.active .sidebar-link
        aria-current="page"}
    :::
...
# [\#](project.html#了解界面){.header-anchor} 了解界面

## [\#](project.html#界面布局){.header-anchor} 界面布局

`AIoT-IDE` 的主窗口由几个主要区域构成，具体如下：

1.**侧边栏**：提供资源管理器、搜索、Git
管理、插件市场、快捷入口等功能。\
...
## [\#](project.html#工具栏界面){.header-anchor} 工具栏界面

`AIoT-IDE` 工具栏界面中含有几个常用功能：

**选择设备**：选择本地创建的模拟器\
**调试**：编译预览当前打开的**Xiaomi Vela
JS**应用项目，并打开调试面板，调试当前项目\
...
## [\#](project.html#模拟器界面){.header-anchor} 模拟器界面
...
## [\#](project.html#用户引导页){.header-anchor} 用户引导页

模拟器**用户引导页**会引导用户初始化**Xiaomi Vela
JS**应用模拟器运行环境。按引导页提示进行操作:

-   1.**安装项目依赖**，等待项目依赖和环境安装完成，才能正常编译预览**Xiaomi
    Vela JS**应用项目
...
::: page-nav
[ ← [关于AIoT-IDE](../index.html){.prev .router-link-active} ]{.prev} [
[新建项目](../project/creat-project.html) → ]{.next}
:::
:::
...
[界面布局](project.html#界面布局 "界面布局")
:::

::: {.vuepress-toc-item .vuepress-toc-h2}
[工具栏界面](project.html#工具栏界面 "工具栏界面")
:::

::: {.vuepress-toc-item .vuepress-toc-h2}
[模拟器界面](project.html#模拟器界面 "模拟器界面")
:::

::: {.vuepress-toc-item .vuepress-toc-h2}
[用户引导页](project.html#用户引导页 "用户引导页")
:::

::: {.vuepress-toc-item .vuepress-toc-h2}
[设备管理页](project.html#设备管理页 "设备管理页")
:::

::: {.vuepress-toc-item .vuepress-toc-h2}
[模拟器运行预览页面](project.html#模拟器运行预览页面 "模拟器运行预览页面")
:::
:::
:::
